...
../generate_plots/generate_matplotlib.py --num-images 1000 --width 1280 --height 960 mpl/1280x960
...
../generate_plots/generate_matplotlib.py --no-antialiasing --num-images 1000 --width 1280 --height 960 mpl-no-aa/1280x960 &
...
../generate_plots/generate_matplotlib.py --scatter --num-images 1000 --width 1280 --height 960 mpl-scatter/1280x960 &
...
../generate_plots/generate_opencv.py --num-drawings 1000 --width 1280 --height 960 opencv-drawings/1280x960 &
...
../generate_plots/generate_opencv.py --background-dir imagenette2 --num-drawings 1000 --width 1280 --height 960 opencv-drawings-bg/1280x960 &
